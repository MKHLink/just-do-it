...
import { GET_WORKOUT_TYPE_SHOULDERS } from "../utils/queries";
import Card from 'react-bootstrap/Card';

function WorkoutShoulders() {
  const { data,loading } = useQuery(GET_WORKOUT_TYPE_SHOULDERS);
...
export default WorkoutShoulders;